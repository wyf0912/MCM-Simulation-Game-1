...
\indent
Bubble is considered to  mainly influence heat loss model. We calculate the reflection coefficient to modify the value of radiation in heat loss model. Because the air in the bubble will be saturated in a short time, we ignore the evaporation in the heat loss model.\\
\indent
We simulate under different conditions, give the results. And the effects of different factors are compared and analyzed. \\
...
\begin{table}[H]
	\setlength{\abovecaptionskip}{0pt}
	\setlength{\belowcaptionskip}{0pt}
	\centering{Table 3:Circle shaped bathtub simulation result}\\
...
Through the analysis of Table 4, We can get the following conclusions
\begin{itemize}
