...
\label{PID1}
\end{figure}
\indent We simulated the PID algorithm in the environment of under the condition of 18 C degrees at room temperature, the initial water quantity of 150L.
